...
A = np.array([[make(Q1, 0, 0, N, config, pt, 'A'), make(Q1, 0, 1, N, config, pt, 'A'), 0],
...
r1 = F1*s11 + F2*s22
if (r1**2 - 4*r2*(-1))>=0:
  tsai_R = [(-r1+sqrt(r1**2-4*r2*(-1)))/(2*r2), (-r1-sqrt(r1**2-4*r2*(-1)))/(2*r2)]

# calculator
#print('midstrain: ', midstrain)
#print('curvature', curvature)
#print('global strain', plystrain)
#print('local strain', locstrain)
print('ply: ', ply)
#print('local stress', locstress)
#print('maximum stress failure', maxstress_R)
print('tsai-wu failure', tsai_R)
